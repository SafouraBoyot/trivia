...
public class SomeTest {
	...
	public void trivia_game_should_play_game_until_find_a_winner(){
		String expectedResult = getExpectedResult_for_seed_0ne();
	...
	private String getExpectedResult_for_seed_0ne(){
	...
	private String getExpectedResult_for_seed_two(){
			return "Chet was added\n" +
					"They are player number 1\n" +
					"Pat was added\n" +
					"They are player number 2\n" +
	...
	public String getExpectedResult_for_seed_three(){
		return "Chet was added\n" +
				"They are player number 1\n" +
				"Pat was added\n" +
				"They are player number 2\n" +
